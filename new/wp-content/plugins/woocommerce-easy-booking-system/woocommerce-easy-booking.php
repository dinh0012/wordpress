...
* Plugin URI: https://www.easy-booking.me/addon/woocommerce-easy-booking/
...
class Easy_booking {
    ...
    **/
    ...
    /**
    *
    * Display a notice on the admin to inform about the addons and updates
    *
    **/
    public function wceb_add_notices() {
        ...
        if ( get_option( 'easy_booking_display_notice_wceb-statuses' ) != 1 ) {
            include_once( 'includes/admin/views/wceb-html-notice-statuses.php' );
        }
    }
    ...
    **/
    public function wceb_add_settings_link( $links ) {
        $settings_link = '<a href="admin.php?page=easy-booking">' . esc_html__( 'Settings', 'easy_booking' ) . '</a>';
