...
class WCEB_Product_View {
	...
	public function __construct() {
        ...
        add_filter( 'woocommerce_product_addons_option_price', array( $this, 'wceb_product_addons_option_price' ), 10, 4 );
	}
    ...
    *
    **/
    public function wceb_product_addons_option_price( $price, $option, $i, $type ) {
        global $product;
