...
class Ts_Generator_Views {
	...
	public static function bool( $id, $field ) {
		$return = '<span class="ts-generator-switch ts-generator-switch-' . $field['default'] . '"><span class="ts-generator-yes">' . __( 'Yes', 'themestall' ) . '</span><span class="ts-generator-no">' . __( 'No', 'themestall' ) . '</span></span><input type="hidden" name="' . $id . '" value="' . esc_attr( $field['default'] ) . '" id="ts-generator-attr-' . $id . '" class="ts-generator-attr ts-generator-switch-value" />';
		return $return;
	}

	public static function upload( $id, $field ) {
		$return = '<input type="text" name="' . $id . '" value="' . esc_attr( $field['default'] ) . '" id="ts-generator-attr-' . $id . '" class="ts-generator-attr ts-generator-upload-value" /><div class="ts-generator-field-actions"><a href="javascript:;" class="button ts-generator-upload-button"><img src="' . admin_url( '/images/media-button.png' ) . '" alt="' . __( 'Media manager', 'themestall' ) . '" />' . __( 'Media manager', 'themestall' ) . '</a></div>';
		return $return;
	}

	public static function icon( $id, $field ) {
		$return = '<input type="text" name="' . $id . '" value="' . esc_attr( $field['default'] ) . '" id="ts-generator-attr-' . $id . '" class="ts-generator-attr ts-generator-icon-picker-value" /><div class="ts-generator-field-actions"><a href="javascript:;" class="button ts-generator-upload-button ts-generator-field-action"><img src="' . admin_url( '/images/media-button.png' ) . '" alt="' . __( 'Media manager', 'themestall' ) . '" />' . __( 'Media manager', 'themestall' ) . '</a> <a href="javascript:;" class="button ts-generator-icon-picker-button ts-generator-field-action"><img src="' . admin_url( '/images/media-button-other.gif' ) . '" alt="' . __( 'Icon picker', 'themestall' ) . '" />' . __( 'Icon picker', 'themestall' ) . '</a></div>
		<div class="ts-generator-icon-picker ts-generator-clearfix"><input type="text" class="widefat" placeholder="' . __( 'Filter icons', 'themestall' ) . '" /></div>';
		return $return;
	}
	...
	public static function gallery( $id, $field ) {
		$shult = ThemeStall_shortcodes();
		// Prepare galleries list
		$galleries = $shult->get_option( 'galleries' );
		$created = ( is_array( $galleries ) && count( $galleries ) ) ? true : false;
		$return = '<select name="' . $id . '" id="ts-generator-attr-' . $id . '" class="ts-generator-attr" data-loading="' . __( 'Please wait', 'themestall' ) . '">';
		...
		if ( $created ) // Create options
			foreach ( $galleries as $g_id => $gallery ) {
				...
				// Prepare title
				$gallery['name'] = ( $gallery['name'] == '' ) ? __( 'Untitled gallery', 'themestall' ) : stripslashes( $gallery['name'] );
				// Create option
				$return .= '<option value="' . ( $g_id + 1 ) . '"' . $selected . '>' . $gallery['name'] . '</option>';
			}
		// Galleries not created
		else
			$return .= '<option value="0" selected>' . __( 'Galleries not found', 'themestall' ) . '</option>';
		$return .= '</select><small class="description"><a href="' . $shult->admin_url . '#tab-3" target="_blank">' . __( 'Manage galleries', 'themestall' ) . '</a>&nbsp;&nbsp;&nbsp;<a href="javascript:;" class="ts-generator-reload-galleries">' . __( 'Reload galleries', 'themestall' ) . '</a></small>';
		return $return;
	}
	...
	public static function shadow( $id, $field ) {
		...
		$return = '<div class="ts-generator-shadow-picker"><span class="ts-generator-shadow-picker-field"><input type="number" min="-1000" max="1000" step="1" value="' . $defaults[0] . '" class="ts-generator-sp-hoff" /><small>' . __( 'Horizontal offset', 'themestall' ) . ' (px)</small></span><span class="ts-generator-shadow-picker-field"><input type="number" min="-1000" max="1000" step="1" value="' . $defaults[1] . '" class="ts-generator-sp-voff" /><small>' . __( 'Vertical offset', 'themestall' ) . ' (px)</small></span><span class="ts-generator-shadow-picker-field"><input type="number" min="-1000" max="1000" step="1" value="' . $defaults[2] . '" class="ts-generator-sp-blur" /><small>' . __( 'Blur', 'themestall' ) . ' (px)</small></span><span class="ts-generator-shadow-picker-field ts-generator-shadow-picker-color"><span class="ts-generator-shadow-picker-color-wheel"></span><input type="text" value="' . $defaults[3] . '" class="ts-generator-shadow-picker-color-value" /><small>' . __( 'Color', 'themestall' ) . '</small></span><input type="hidden" name="' . $id . '" value="' . esc_attr( $field['default'] ) . '" id="ts-generator-attr-' . $id . '" class="ts-generator-attr" /></div>';
		return $return;
	}
	...
	public static function border( $id, $field ) {
		...
		$return = '<div class="ts-generator-border-picker"><span class="ts-generator-border-picker-field"><input type="number" min="-1000" max="1000" step="1" value="' . $defaults[0] . '" class="ts-generator-bp-width" /><small>' . __( 'Border width', 'themestall' ) . ' (px)</small></span><span class="ts-generator-border-picker-field">' . $borders . '<small>' . __( 'Border style', 'themestall' ) . '</small></span><span class="ts-generator-border-picker-field ts-generator-border-picker-color"><span class="ts-generator-border-picker-color-wheel"></span><input type="text" value="' . $defaults[2] . '" class="ts-generator-border-picker-color-value" /><small>' . __( 'Border color', 'themestall' ) . '</small></span><input type="hidden" name="' . $id . '" value="' . esc_attr( $field['default'] ) . '" id="ts-generator-attr-' . $id . '" class="ts-generator-attr" /></div>';
		return $return;
	}
	...
	public static function image_source( $id, $field ) {
		...
		$sources = Ts_Tools::select( array(
				'options'  => array(
					'media'         => __( 'Media library', 'themestall' ),
					'posts: recent' => __( 'Recent posts', 'themestall' ),
					'category'      => __( 'Category', 'themestall' ),
					'taxonomy'      => __( 'Taxonomy', 'themestall' )
				),
				'selected' => '0',
				'none'     => __( 'Select images source', 'themestall' ) . '&hellip;',
		...
		$taxonomies = Ts_Tools::select( array(
				...
				'none'     => __( 'Select taxonomy', 'themestall' ) . '&hellip;',
				'selected' => '0',
		...
		$return = '<div class="ts-generator-isp">' . $sources . '<div class="ts-generator-isp-source ts-generator-isp-source-media"><div class="ts-generator-clearfix"><a href="javascript:;" class="button button-primary ts-generator-isp-add-media"><i class="fa fa-plus"></i>&nbsp;&nbsp;' . __( 'Add images', 'themestall' ) . '</a></div><div class="ts-generator-isp-images ts-generator-clearfix"><em class="description">' . __( 'Click the button above and select images.<br>You can select multimple images with Ctrl (Cmd) key', 'themestall' ) . '</em></div></div><div class="ts-generator-isp-source ts-generator-isp-source-category"><em class="description">' . __( 'Select categories to retrieve posts from.<br>You can select multiple categories with Ctrl (Cmd) key', 'themestall' ) . '</em>' . $categories . '</div><div class="ts-generator-isp-source ts-generator-isp-source-taxonomy"><em class="description">' . __( 'Select taxonomy and it\'s terms.<br>You can select multiple terms with Ctrl (Cmd) key', 'themestall' ) . '</em>' . $taxonomies . $terms . '</div><input type="hidden" name="' . $id . '" value="' . $field['default'] . '" id="ts-generator-attr-' . $id . '" class="ts-generator-attr" /></div>';
		return $return;
	}
