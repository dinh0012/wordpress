...
<body <?php body_class(); ?>>
    ...
    ********************************************** -->
	<div id="wrapper">
    	<?php truvatour_child_custom_search_form(); ?>
        
    	<?php 
		$logo = (function_exists('ot_get_option'))? ot_get_option( 'main_logo', TRUVATOURTHEMEURI. '/images/logo.png' ) : TRUVATOURTHEMEURI. '/images/logo.png';
		$header_banner_type = get_post_meta( get_the_ID(), 'header_banner_type', true ); 
		if($header_banner_type == 'featured_image' && has_post_thumbnail()):
		$logo = (function_exists('ot_get_option'))? ot_get_option( 'main_logo_alt', TRUVATOURTHEMEURI. '/images/logo-white.png' ) : TRUVATOURTHEMEURI. '/images/logo-white.png';
		?>
    	...
    	<header class="header" data-spy="affix" data-offset-top="150">
         ...
         <?php $header_banner_type = get_post_meta( get_the_ID(), 'header_banner_type', true ); 
		if($header_banner_type == 'featured_image' && has_post_thumbnail()):
		?>
        </div>
        <?php endif; ?>
